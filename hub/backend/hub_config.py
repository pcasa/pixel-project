...
def get_anthropic_api_key() -> str:
    return _env_first("ANTHROPIC_API_KEY", "anthropic_api_key")
...
def hub_settings_public_view() -> dict[str, Any]:
    ...
    return {
        ...
        "anthropic_api_key_configured": bool(ak),
        "anthropic_api_key_masked": mask_secret(ak) if ak else None,
